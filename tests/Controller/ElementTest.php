...
class ElementTest extends ControllerTestCase {
    ...
    private const TYPEAHEAD_QUERY = 'element';
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/element/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAnonNewPopup() : void {
        $crawler = $this->client->request('GET', '/element/new_popup');
        $this->assertResponseRedirects('/login', Response::HTTP_FOUND);
    }
    ...
    public function testAdminNewPopup() : void {
        ...
        $this->client->submit($form);
        $this->assertResponseRedirects('/element/7', Response::HTTP_FOUND);
        $responseCrawler = $this->client->followRedirect();
        $this->assertResponseIsSuccessful();
    }

    public function testAdminDelete() : void {
        /** @var ElementRepository $repo */
